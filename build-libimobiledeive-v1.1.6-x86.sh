...
export CFLAGS='-Wno-error -arch i386'
export CPPFLAGS="-Wno-error -arch i386"
export CXXFLAGS="-Wno-error -arch i386"
...
cd openssl-1.0.1h
./Configure --prefix=$CURRENT_DIR/$DIST_DIR_NAME --openssldir=$CURRENT_DIR/$DIST_DIR_NAME/openssl zlib-dynamic shared enable-cms darwin-i386-cc enable-ec_nistp-64_gcc_128
make depend
make install
cd $CURRENT_DIR
#----------------------------------------------------------------------------------------#
